...
import ec.gob.mag.seguridades.util.ModifyString;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleUnexpectedRollbackException(Exception ex, WebRequest request) {
		return buildException(null, HttpStatus.INTERNAL_SERVER_ERROR, "error.unrollback_validation.message", null, null,
				null);
	}
